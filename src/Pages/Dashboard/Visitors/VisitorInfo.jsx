  ...
  return (
    <div class="relative">
          ...
          onClick={()=> setSelectedVisitor(visitor)}
            for="visitor1"
            class="block cursor-pointer rounded-xl p-6 shadow-lg text-white bg-gradient-to-r from-[#043915] to-[#4C763B] hover:from-primary hover:to-green-500 hover:scale-105 transform transition"
          >
            <div class="flex items-center space-x-3">
                 <i class="fas fa-network-wired text-2xl"><FaNetworkWired/> </i>
              <div>
                <div class="font-semibold text-lg">{visitor?.ip}</div>
                <div class="text-sm opacity-80">{visitor?.location.city}</div>
              </div>
            </div>
          </label>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-gradient-to-r from-purple-400 to-indigo-400 text-white p-4 rounded-xl shadow hover:scale-105 transform transition flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div class="font-semibold">{selectedVisitor?.ip}</div>
                  </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-green-400 to-teal-500 text-white p-4 rounded-xl shadow hover:scale-105 transform transition flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div class="font-semibold">{selectedVisitor?.location.city}, {selectedVisitor?.location.region}, {selectedVisitor?.location.country}</div>
                    <div class="text-xs mt-1">Lat/Lng: {selectedVisitor?.location.loc}</div>
                  </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-blue-400 to-cyan-500 text-white p-4 rounded-xl shadow hover:scale-105 transform transition flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div class="font-semibold">{selectedVisitor?.userAgent.browserName}</div>
                    <div class="text-xs mt-1">Version: {selectedVisitor?.userAgent.browserVersion}</div>
                  </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-pink-400 to-rose-500 text-white p-4 rounded-xl shadow hover:scale-105 transform transition flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div class="font-semibold">{selectedVisitor?.userAgent.os}</div>
                    <div class="text-xs mt-1">{selectedVisitor?.userAgent.osVersion}</div>
                  </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-yellow-400 to-orange-500 text-white p-4 rounded-xl shadow hover:scale-105 transform transition flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div class="font-semibold">{selectedVisitor?.userAgent.deviceType}</div>
                    <div class="text-xs mt-1">Vendor: {selectedVisitor?.userAgent.deviceVendor}</div>
                  </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-blue-300 to-teal-400 text-white p-4 rounded-xl shadow hover:scale-105 transform transition flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div class="font-semibold">Asia/Riyadh</div>
                  </div>
                </div>
              </div>
            </div>
