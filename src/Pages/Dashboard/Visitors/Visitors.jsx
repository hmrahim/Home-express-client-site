              ...
              return (
                <div className="relative">
                  ...
                  <label
                    ...
                    for="visitor1"
                    className="block cursor-pointer rounded-xl p-6 shadow-lg text-white bg-gradient-to-r from-green-500 to-emerald-600 hover:from-primary hover:to-green-500 hover:scale-105 transform transition"
                  >
                    <div className="flex items-center space-x-3">
                      <i className="fas fa-network-wired text-2xl">
                        <FaNetworkWired />{" "}
                      </i>
                      <div>
