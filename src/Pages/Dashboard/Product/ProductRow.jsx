...
function truncate(str, maxlength) {
  ...
  return (
    <tr>
      ...
      <td className="text-center">{product.discount? product.discount+ "%" : "No Discount" }</td>
      ...
      <th className="flex gap-5">
          ...
          <Link to={`/dashboard/update-product/${product._id}`} className="btn btn-xs btn-primary">Edit</Link>
          <button onClick={()=> deleteProduct(product._id)} className="btn btn-xs btn-error">Delete</button>
