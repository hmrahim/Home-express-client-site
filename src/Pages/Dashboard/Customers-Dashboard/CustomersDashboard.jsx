  ...
  return (
    <div>
      ...
      <div className="w-full min-h-screen bg-gray-300 mt-16 md:mt-16 font-serif">
        <div className="s-full md:w-5/6 mx-auto flex flex-col  md:flex-row md:flex-row-reverse  flex-col-reverse justify-around  py-5 gap-5 px-5">
          ...
          <div className="bg-base-100 md:w-1/4 w-full px-2 rounded-lg">
            <div class=" rounded-xl overflow-hidden h-screen  flex flex-col items-center shadow-lg bg-white font-Roboto-light">
              ...
              <div className=" flex flex-col mt-4">
                <h1 className="metallic-text mt-16">{data?.data.name}</h1>
                <p className="text-center font-bold m-0">{data?.data.email}</p>
                <Link className="btn btn-xs btn-primary ">Edit Profile</Link>
                <div className="divider"></div>
              </div>
              <div>
                <ul className="menu menu-md bg-base-300 rounded-box md:w-60 w-96">
                  <li className="hover:bg-primary rounded-lg bg-base-300 border-b-2 border-primary mb-2">
                    <Link className="hover:text-base-100">Profile</Link>
                  </li>
                  <li className="hover:bg-primary rounded-lg bg-base-300 border-b-2 border-primary mb-2">
                    <Link className="hover:text-base-100">Confirmed Order</Link>
                  </li>
                  <li className="hover:bg-primary rounded-lg bg-base-300 border-b-2 border-primary mb-2">
                    <Link className="hover:text-base-100">Medium 1</Link>
                  </li>
                  <li className="hover:bg-primary rounded-lg bg-base-300 border-b-2 border-primary mb-2">
                    <Link className="hover:text-base-100">Medium 1</Link>
                  </li>
