...
import { postPromocode } from "../../../api/AllApi";
...
const AddPromoCode = () => {
  ...
  const mutation = useMutation({
    mutationFn: (data) => postPromocode(data),
    onSuccess:(res)=> {
      if(res.status === 200){

        toast.success("Promo created succesfully")
        reset()
      }
