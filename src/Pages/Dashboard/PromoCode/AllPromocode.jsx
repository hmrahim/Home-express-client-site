    ...
    <div>
      <div className="bg-base-200 min-h-screen pt-10 px-5 md:px-0 ">
        ...
        >
          ...
          <div class="overflow-x-auto bg-white mt-2 shadow">
            <table class="min-w-full text-sm text-left text-gray-700">
              <thead class="bg-gray-50 text-xs uppercase text-gray-600">
                <tr className="bg-gradient-to-r from-green-500 to-emerald-600 text-base-100">
                  ...
                  <th class="px-4 text-center">Code</th>
                  <th class="px-4 text-center">Description</th>
                  <th class="px-4 text-center">Discount Type</th>
                  <th class="px-4 text-center">Discount Value</th>
                  <th class="px-4 text-center">Min Purchase</th>
                  <th class="px-4 text-center">Max Discount</th>
                  <th class="px-4 text-center">Usage Limit</th>
                  <th class="px-4 text-center">Usage Count</th>
                  <th class="px-4 text-center">Start Date</th>
                  <th class="px-4 text-center">End Date</th>
                  <th class="px-4 text-center text-center">Active</th>
                  <th class="px-4 text-center text-center">Action</th>
                </tr>
              </thead>
